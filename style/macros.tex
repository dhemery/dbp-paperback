...
\def\ensureevenpagecount{\ifodd\pageno\cleartorecto\else\fi}
...
\def\titlepagetitlestyle{\titlepagetitlefont\raggedleft}
\def\titlepageauthor#1{{\titlepageauthorstyle#1\par}}
\def\titlepageauthorstyle{\titlepageauthorfont\raggedleft}
\def\titlepagepublisher#1{{\titlepagepublisherstyle#1\par}}
\def\titlepagepublisherstyle{\titlepagepublisherfont\raggedleft}
...
\def\infopage#1{\clearpage\infopagetitle{#1}}
\def\infopagetitle#1{{\infopagetitlestyle{#1}\par}}
\def\infopagetitlestyle{\infopagetitlefont\centered}
...
\def\scenetitlestyle{\noindent\scenetitlefont\raggedleft}
...
\def\raggedleft{\leftskip=0pt plus \hsize minus \parindent \parfillskip=0pt\relax}
\def\raggedright{\rightskip=0pt plus \hsize minus \parindent \parfillskip=0pt\relax}
