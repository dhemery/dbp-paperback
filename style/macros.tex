...
\def\section#1{
  \nextpage
  \displaypagetrue
  \typesetsectionheading{#1}
}

\def\typesetsectionheading#1{
  \vbox{
    \vskip3\baselineskip
    {\raggedleft\sectiontitlefont\baselineskip=\fontdimen6\sectiontitlefont#1\par}
    \vskip\baselineskip
  }
  \nobreak
}
...
\def\infopage#1{\nextpage\useemptypageframe{\sectiontitlefont\baselineskip=\fontdimen6\sectiontitlefont\centered#1\par}}
