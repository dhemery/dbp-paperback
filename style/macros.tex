...
% Empty headline and footline
\def\useemptypageframe{
  \global\headline={\line{}}
  \global\footline={\line{}}
}

% Empty headline on this page, then normal page frame
\def\usedisplaypageframe{
  \global\headline={\line{}\usenormalpageframe}
}

% Headline: Centered author (verso) and title (recto)
% Footline: Centered page number
\def\usenormalpageframe{%
  \global\headline={\headlinefont\hfil\ifodd\pageno\title\else\author\fi\hfil}%
  \global\footline={\footlinefont\hfil\folio\hfil}%
}
