...
%
% Paper and Margins
% TODO: Move to fiction.tex?
% In general I don't want to take action in fiction.tex.
% But that may be the best place to set the output routine.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%
% Pages
% TODO: Where to put the title and preview macros?
%       They seem closely associated with the publisher.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
