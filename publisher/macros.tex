...
\def\booktitle#1{{\usefont\booktitlefont\raggedleft\uppercase{#1}\par}}
\def\authorname#1{{\authornamefont\raggedleft\uppercase{#1}\par}}
...
\def\genrebook#1{\authorinfoitem{\bodyit#1}}
