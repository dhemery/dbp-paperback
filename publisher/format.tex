...
\def\runningpageframe{0}
\def\clearedpageframe{1}
\def\displaypageframe{2}
\def\useemptyframethispage{\global\let\pageframe=\clearedpageframe}
\def\usedisplayframethispage{\global\let\pageframe=\displaypageframe}
\def\userunningpageframe{\global\let\pageframe=\runningpageframe}
\userunningpageframe

% Write one page (headline, textblock, and footline).
\def\facingpages{%
  \if\pageframe\clearedpageframe\headline={\line{}}\footline={\line{}}\fi%
  \if\pageframe\displaypageframe\headline={\line{}}\footline={\displaypagefootline}\fi%
  \userunningpageframe
...
\def\nextpage{\vfil\eject\useemptyframethispage}
\def\nextoddpage{\nextpage\onoddpage}
