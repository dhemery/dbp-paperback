...
% Skipping lines
\def\skipline{\vskip\leading plus0pt minus0pt}
\def\skiphalfline{\vskip.5\leading plus0pt minus0pt}
...
% Paper
\pdfpagewidth=5 true in   % width
\pdfpageheight=8 true in  % height
