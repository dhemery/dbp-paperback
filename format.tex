...
\def\previewannouncementpage#1{
  ...
  \vfill
  {\offinterlineskip\booktitlefont\centered #1\par}
  \vskip\baselineskip
  \centerline{by}
  \vskip\baselineskip
...
\def\previewavailablepage#1{
  \nextoddpage
  \line{}\vfill
  \line{\hss{\offinterlineskip\booktitlefont #1}\hss}
  \vskip\baselineskip
  \centerline{by}
  \vskip\baselineskip
...
\def\part#1{
  ...
  \baselinebox{\parttitle{#1}\nobreak}{6}{}
}

\def\chapter#1{\baselinebox{\chaptertitle{#1}}{3}{1}}

% \bookinfo is a named frontmatter or backmatter division.
\def\bookinfo#1{\nextpage\useemptypageframe{\offinterlineskip\chaptertitlefont\centered#1\par}}
...
\def\booktitle#1{{\offinterlineskip\booktitlefont\raggedleft{\expandafter\uppercase{#1}}\par}}
\def\authorname#1{{\authornamefont\raggedleft{\expandafter\uppercase{#1}}\par}}
\def\parttitle#1{{\raggedleft\offinterlineskip\parttitlefont#1\par}}
\def\chaptertitle#1{{\offinterlineskip\ifodd\pageno\raggedleft\else\raggedright\fi\chaptertitlefont{#1}\par}}
