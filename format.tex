...
\def\bookinfo#1{\nextpage\useemptypageframe{\chaptertitlefont\titlespacing\centered#1\par}}
...
\def\booktitle#1{{\booktitlefont\titlespacing\raggedleft{\expandafter\uppercase{#1}}\par}}
\def\authorname#1{{\authornamefont\titlespacing\raggedleft{\expandafter\uppercase{#1}}\par}}
\def\parttitle#1{{\raggedleft\parttitlefont\titlespacing#1\par}}
\def\chaptertitle#1{{\ifodd\pageno\raggedleft\else\raggedright\fi\chaptertitlefont\titlespacing{#1}\par}}
